...
def step(points, model):
    ...
    # TODO : Implement step function for AutoEncoder. -- Partially DONE
    # Hint : Use chamferDist defined in above
    points = points.to(device)
    decoded_output = model(points)
    loss = chamferDist(points, decoded_output)
    preds = torch.argmax(decoded_output, dim=1) #Why do we need prediction here? 
